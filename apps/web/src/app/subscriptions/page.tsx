...
import { SubscriptionsTable, type SortField } from "@/components/subscriptions/SubscriptionsTable";
import { SubscriptionCards } from "@/components/subscriptions/SubscriptionCards";
import { subscriptionRows } from "@/data/subscriptions";
...
export default function SubscriptionsPage() {
  const [rows, setRows] = useState<SubscriptionRow[]>(subscriptionRows);
  ...
  const handleMarkDone = (id: string) => {
    ...
    setToastMessage("Subscription status updated.");
  };
        ...
        <div className="fixed inset-0 z-30 grid place-items-center bg-slate-950/40 px-4 py-6">
          <div className="w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl">
            ...
            <p className="mt-2 text-sm text-slate-600">
              This action will remove the subscription from the list. You can undo it by re-adding the service later.
            </p>
